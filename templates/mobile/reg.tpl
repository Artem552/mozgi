...
<select id="year" class="inp sel_reg" style="margin-bottom:10px">
 ...
 <option value="2008">2008</option><option value="2009">2009</option><option value="2010">2010</option><option value="2011">2011</option><option value="2012">2012</option><option value="2013">2013</option><option value="2014">2014</option><option value="2015">2015</option>
</select>
<select id="country" class="inp sel_reg" style="margin-bottom:10px" onChange="Profile.LoadCity(this.value); return false;"><option value="0">Выбрать страну</option>{country}
</select>
<select name="city" id="select_city" class="inp sel_reg" style="margin-bottom:10px"><option>Выбрать город</option></select>
