...
<head>
<link rel="shortcut icon" type="image/x-icon" href="foto/favicon.ico">
{header}
...
<div class="autowr">
 [not-logged]<div class="leftpanel">
  <form method="POST" action="">
   ...
   <div class="logpos">
    <button name="log_in" class="blue_button2" style="width:139px">Войти</button></div>
 ...
 <div class="content" [logged]style="width:800px;"[/logged]>
  ...
  <div class="footer">
   ИнфоБаку &copy; 2015 <a class="cursor_pointer" onClick="trsn.box()" onMouseOver="myhtml.title('1', 'Выбор используемого языка на сайте', 'langTitle', 1)" id="langTitle1">{lang}</a>
   <div class="fl_r">
